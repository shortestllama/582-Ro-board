...
class MyClass(GeneratedClass):
    ...
    def onInput_onStart(self):
        ...
        time.sleep(1)
        self.motion.setAngles(request, [3 * almath.TO_RAD, 18 * almath.TO_RAD, 100 * almath.TO_RAD, 3 * almath.TO_RAD, 104.5 * almath.TO_RAD], 0.2)
        time.sleep(2)
        ...
        self.motion.angleInterpolationWithSpeed(bend, [-46 * almath.TO_RAD, -36 * almath.TO_RAD, 40 * almath.TO_RAD, 42 * almath.TO_RAD, -8 * almath.TO_RAD, -17 * almath.TO_RAD], 0.07)
        time.sleep(2)
